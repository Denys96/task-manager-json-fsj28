            ...
            <tbody>
                ...
                <?php foreach ($data_tasks as $task) { ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            // Colorear según estado (comparación case-insensitive)
                            ...
                            if ($status === 'pendiente') {
                                ...
                                $display = 'Pendiente';
                            } elseif ($status === 'en proceso' || $status === 'enproceso') {
                        ...
                        <td>
                            ...
                            <!-- Botón que llama al controlador para rotar estado -->
                            <a href="../controller/ManagerController.php?change_status=<?php echo $task['id_task']; ?>"
